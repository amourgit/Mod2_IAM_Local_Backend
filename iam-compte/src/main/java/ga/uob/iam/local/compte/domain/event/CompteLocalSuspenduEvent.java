...
/** Émis lors de la suspension d'un CompteLocal. */
public final class CompteLocalSuspenduEvent extends DomainEvent {

    public static final String EVENT_TYPE = "compte.local.suspendu";

    private final String userIdNational;
    private final IdentifiantNational identifiantNational;
    private final String motif;

    public CompteLocalSuspenduEvent(UUID id, String userIdNational,
