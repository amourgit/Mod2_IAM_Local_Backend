...
public class UserEntity {
    ...
    @Column(name = "ID_COMPTE_LOCAL", length = 36)
    protected String idCompteLocal;

    @Column(name = "IDENTIFIANT_NATIONAL", length = 30)
    protected String identifiantNational;
    ...
    // Getters/Setters pour les champs personnalisés IAM Local
    public String getIdCompteLocal() {
        return idCompteLocal;
    }

    public void setIdCompteLocal(String idCompteLocal) {
        this.idCompteLocal = idCompteLocal;
    }
