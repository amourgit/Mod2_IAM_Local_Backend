...
public class UserAdapter implements UserModel, JpaModel<UserEntity> {
    ...
    // Implémentation des méthodes pour les champs personnalisés IAM Local
    @Override
    public String getIdCompteLocal() {
        return user.getIdCompteLocal();
    }

    @Override
    public void setIdCompteLocal(String idCompteLocal) {
        user.setIdCompteLocal(idCompteLocal);
    }

    @Override
    public String getIdentifiantNational() {
        return user.getIdentifiantNational();
    }
