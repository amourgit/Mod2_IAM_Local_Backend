...
public interface UserModel extends RoleMapperModel, Model {
    ...
    // Champs personnalisés IAM Local
    ...
    // Méthodes pour les champs personnalisés IAM Local
    default String getIdCompteLocal() {
        return getFirstAttribute(ID_COMPTE_LOCAL);
    }

    default void setIdCompteLocal(String idCompteLocal) {
        setAttribute(ID_COMPTE_LOCAL, java.util.Collections.singletonList(idCompteLocal));
    }

    default String getIdentifiantNational() {
        return getFirstAttribute(IDENTIFIANT_NATIONAL);
    }

    default void setIdentifiantNational(String identifiantNational) {
        setAttribute(IDENTIFIANT_NATIONAL, java.util.Collections.singletonList(identifiantNational));
    }

    default String getStatutCompte() {
        return getFirstAttribute(STATUT_COMPTE);
    }

    default void setStatutCompte(String statutCompte) {
        setAttribute(STATUT_COMPTE, java.util.Collections.singletonList(statutCompte));
    }
